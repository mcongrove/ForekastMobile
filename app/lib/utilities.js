...
var Utilities = {
	...
	cleanString: function(_string) {
		...
		_string = Utilities.htmlDecode(_string);
	...
	cleanEscapeString: function(_string) {
		_string = Utilities.cleanString(_string);

		return Utilities.escapeString(_string);
	},
	/**
	 * Cleans up nasty XML
	...
	htmlDecode: function(_string) {
		...
		var hash_map = Utilities.htmlTranslationTable();
